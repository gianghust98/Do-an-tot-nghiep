...
public final class UnaryGrpc {
  ...
  public static final String SERVICE_NAME = "unary.Unary";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.webtoeic.unary.UnaryOuterClass.Message,
      com.webtoeic.unary.UnaryOuterClass.MessageResponse> getGetServerResponseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetServerResponse",
      requestType = com.webtoeic.unary.UnaryOuterClass.Message.class,
      responseType = com.webtoeic.unary.UnaryOuterClass.MessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.webtoeic.unary.UnaryOuterClass.Message,
      com.webtoeic.unary.UnaryOuterClass.MessageResponse> getGetServerResponseMethod() {
    io.grpc.MethodDescriptor<com.webtoeic.unary.UnaryOuterClass.Message, com.webtoeic.unary.UnaryOuterClass.MessageResponse> getGetServerResponseMethod;
      ...
      synchronized (UnaryGrpc.class) {
        if ((getGetServerResponseMethod = UnaryGrpc.getGetServerResponseMethod) == null) {
          UnaryGrpc.getGetServerResponseMethod = getGetServerResponseMethod = 
              io.grpc.MethodDescriptor.<com.webtoeic.unary.UnaryOuterClass.Message, com.webtoeic.unary.UnaryOuterClass.MessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "unary.Unary", "GetServerResponse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.webtoeic.unary.UnaryOuterClass.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.webtoeic.unary.UnaryOuterClass.MessageResponse.getDefaultInstance()))
  ...
  public static abstract class UnaryImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getServerResponse(com.webtoeic.unary.UnaryOuterClass.Message request,
        io.grpc.stub.StreamObserver<com.webtoeic.unary.UnaryOuterClass.MessageResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.webtoeic.unary.UnaryOuterClass.Message,
                com.webtoeic.unary.UnaryOuterClass.MessageResponse>(
  ...
  public static final class UnaryBlockingStub extends io.grpc.stub.AbstractStub<UnaryBlockingStub> {
    ...
    /**
     */
    public com.webtoeic.unary.UnaryOuterClass.MessageResponse getServerResponse(com.webtoeic.unary.UnaryOuterClass.Message request) {
  ...
  public static final class UnaryFutureStub extends io.grpc.stub.AbstractStub<UnaryFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.webtoeic.unary.UnaryOuterClass.MessageResponse> getServerResponse(
        com.webtoeic.unary.UnaryOuterClass.Message request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SERVER_RESPONSE:
          serviceImpl.getServerResponse((com.webtoeic.unary.UnaryOuterClass.Message) request,
              (io.grpc.stub.StreamObserver<com.webtoeic.unary.UnaryOuterClass.MessageResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UnaryBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.webtoeic.unary.UnaryOuterClass.getDescriptor();
    }
